    ...
    render() {
        return (
            <div>
                ...
                <Todoing to_do={this.state.to_do} count_num={this.state.count_num} finish={this.state.finish} delTodo={this.delItem} changeTodo={this.changeItem} countTodo={this.counting}/>
            </div>
        )
    }
}